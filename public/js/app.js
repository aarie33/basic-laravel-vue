  ...
  return _c(
    ...
    [
      ...
      _c(
        "form",
        {
          staticClass: "mb-3 p-2 bg-white shadow-sm",
          on: {
      ...
      _vm._l(_vm.articles, function(article) {
        return _c(
          ...
          {
            key: article.id,
            staticClass: "card card-body border-0 mb-2 shadow-sm"
          },
          [
            ...
            _c("div", { staticClass: "d-flex w-100" }, [
              _c(
                "button",
                {
                  staticClass: "btn btn-warning w-50 mr-1",
                  on: {
                    click: function($event) {
              ...
              _c(
                "button",
                {
                  staticClass: "btn btn-danger w-50 ml-1",
                  on: {
                    click: function($event) {
...
__webpack_require__(/*! C:\projects\php\learn-laravel-vue\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\projects\php\learn-laravel-vue\resources\sass\app.scss */"./resources/sass/app.scss");
